      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            <h1 className="text-5xl font-bold mb-6">About Heroes Freight Forwarder Ltd.</h1>
            <p className="text-xl max-w-3xl mx-auto">Your Reliable Logistics Partner in Tanzania and Beyond</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Strategically Located</h2>
            <p className="text-xl text-gray-600">Based in the heart of Dar es Salaam, Tanzania's commercial capital</p>
          </div>
          <div className="relative max-w-4xl mx-auto">
            <Image
              src="/images/port-aerial.jpeg"
              alt="Dar es Salaam port aerial view"
              width={1200}
              height={600}
              className="rounded-lg shadow-lg"
            />
