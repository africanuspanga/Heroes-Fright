        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <Link href="mailto:info@heroes.co.tz" className="text-white hover:text-blue-400">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/industries" className="text-white hover:text-blue-400">
                  Industries
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white text-sm">+255 752 223 4292</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-5 w-5 text-blue-400" />
                <span className="text-white text-sm">info@heroes.co.tz</span>
              </div>
            </div>
          </div>
        </div>
